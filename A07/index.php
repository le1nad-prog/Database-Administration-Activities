...
if (isset($_POST['btnDelete'])) {
  ...
  $deleteQuery = "DELETE FROM posts WHERE postID = '$deletePost'";
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-12 col-xl-6 col-lg-8 col-md-12 pt-3 d-flex justify-content-center">
        <div>
          <div class="wymCard p-3 mt-5 mb-2" style="width: 100%; max-width: 500px; height: 140px;">
            <div class="d-flex align-items-center mb-3">
              ...
              <form method="POST" class="w-100">
                <div class="d-flex align-items-center">
                  <input name="woym" type="text" class="form-control" placeholder="What's on your mind?"
                    style="border: none; background-color: #3a3b3c; border-radius: 20px; height: 40px; color: #B7BABE;">
            ...
            <div class="d-flex justify-content-center">
              <button class="btn d-flex align-items-center"
                style="border-radius: 10px; max-width: 100%; width: 175px; height: 40px; max-height: 100%; color: #B7BABE;">
              ...
              if (!empty($posts["content"])) {
                ...
                <div class="postCard rounded-4 shadow-sm my-2" style="width: 100%; max-width: 500px; margin-bottom: 20px;">
                    ...
                    <div class="header d-flex align-items-center mb-3">
                      ...
                      <div class="flex-grow-1"> 
                        ...
                        <small class="timestamp">
                          <?php echo isset($posts['dateTime']) ? date("M j, Y", strtotime($posts['dateTime'])) : "Date not available"; ?>
                        </small>
                      </div>
                      <a href="edit.php?id=<?php echo $posts['postID']?>">
                        <button class="btn btnFunction" style="background: none; border: none;">
                            <i class="fa-solid fa-pen" style="font-size: 15px; color: #B7BABE;"></i>
                        </button>
                      </a>
                      <form method="post">
                        <input type="hidden" value="<?php echo $posts['postID']; ?>" name="delete">
                        <button type="submit" class="btn" name="btnDelete" aria-label="Close" style="background: none; border: none; padding: 0;">
                          <i class="fa-solid fa-xmark" style="font-size: 25px; color: #B7BABE; padding-right: 5px; padding-top: 5px;"></i>
                        </button>
                      </form>
                    </div>
                  ...
                  <div class="d-flex justify-content-evenly border-top p-2">
                    <button class="btn d-flex justify-content-center align-items-center" style="width: 150px; color:#B7BABE;">
