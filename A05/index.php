  ...
  <div class="container-fluid">
    <div class="row">
            ...
            if (mysqli_num_rows($result)) {
              while ($posts = mysqli_fetch_assoc($result)) {
                if (!empty($posts["content"])) {
                  ?>
                    <div class="postCard rounded-4 shadow my-2" style="width: 100%; max-width: 500px; margin-bottom: 20px;">
                      <div class="card-body">
                        <div class="header d-flex align-items-center mb-3">
                          <img src="images/<?php echo $posts['attachment'] ?>" alt="User Profile" width="40" height="40"
      ...
      <div class="col-3 col-xl-3 col-lg-4 col-md-0 rightSideBar d-none d-lg-block flex-grow-1">
        ...
        $query = "SELECT firstName, lastName, attachment FROM userInfo LEFT JOIN posts ON userInfo.userID = posts.userID"; 
        $result = mysqli_query($conn, $query); 
        
        while ($userInfo = mysqli_fetch_assoc($result)) { 
            ?>
        <button type="button" class="btn btn-secondary text-start d-flex align-items-center">
          <img src="images/<?php echo $userInfo['attachment'] ?>" alt="User Profile" width="30" height="30"
            class="rounded-circle me-2">
